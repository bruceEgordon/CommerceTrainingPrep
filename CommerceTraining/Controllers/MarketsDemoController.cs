...
namespace CommerceTraining.Controllers
{
    public class MarketsDemoController : Controller
    {
        ...
        public MarketsDemoController(IMarketService marketService, ICurrentMarket currentMarket, 
            ...
            IOrderRepository orderRepository, IOrderGroupFactory orderGroupFactory, ITaxCalculator taxCalculator,
            IPriceService priceService, IPromotionEngine promotionEngine)
        {
        ...
        private void GetPriceInfo(DemoMarketsViewModel viewModel)
        {
            ...
            var custPricing = new List<CustomerPricing> { new CustomerPricing(CustomerPricing.PriceType.AllCustomers, string.Empty) };
